...
bool segment_and_get_poses(perception::GetSpineLocations::Request &req, perception::GetSpineLocations::Response &res) {
    ...
    perception::GetAxisAlignedBoundingBox(subset_cloud, &surface_pose, &surface_scale);
    ...
    perception::SegmentSurfaceObjects(cloud_out, table_inliers, &object_indices);
    ...
    for (size_t i = 0; i < object_indices.size(); ++i) {
        ...
        *indices = object_indices[i];
        ...
        perception::GetAxisAlignedBoundingBox(object_cloud, &object_pose, &object_scale);
